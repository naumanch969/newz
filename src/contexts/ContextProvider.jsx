...
export const ContextProvider = ({ children }) => {
    ...
    const options = {
        method: 'GET',
        headers: { 'x-api-key': 'pSCiFLrVfOQ75dEDDPogg5SQcFLYTefkZEoxiK84A9k' }
    };
    const fetchHeadlines = async () => {
        try {
            setLoading(true)
            const fetchResult = await fetch(
                `https://api.newscatcherapi.com/v2/latest_headlines?topic=news&countries=pk&lang=en&page_size=[1:100]`
                , options
            )
